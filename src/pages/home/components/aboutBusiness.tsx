...
const AboutBusiness = () => {
    return (
        <section
            id='about-us'
            className='mb-10 w-full py-14 lg:m-auto lg:mb-14 lg:flex lg:flex-row-reverse lg:items-center lg:p-[20px] xl:w-[1200px]'
        >
            ...
            <div className='relative z-5 text-center text-white'>
                ...
                <p className='m-auto mt-[8px] w-[90%] text-[12px] leading-[21px] text-[#FDFDFD] lg:ml-[0] lg:text-justify lg:text-[14px] lg:leading-[27px] lg:font-light'>
