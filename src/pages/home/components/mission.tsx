    ...
    return (
        <section className='relative mb-20 flex-row-reverse items-center justify-center gap-10 p-5 lg:m-auto lg:mb-50 lg:flex lg:w-[1200px]'>
            ...
            <div>
                ...
                <p className='accent-font m-auto w-[350px] text-center text-[18px] font-light text-white lg:w-[500px] lg:text-left lg:text-[17px]'>
                    The world’s zero-fee blockchain, governed by its people.
                </p>
                <h3 className='accent-font mt-10 text-center text-[50px] font-normal text-white lg:text-left lg:text-[40px]'>Mission</h3>
                <p className='accent-font m-auto w-[350px] text-center text-[18px] font-light text-white lg:w-[500px] lg:text-left lg:text-[17px]'>
